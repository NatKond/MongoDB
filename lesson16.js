...
// Вывести сотрудников, которым меньше 30 и зарплата меньше 5000
...
// Вывести сотрудников, у которых навык равен либо ['curating a wine list', 'creating wine pairings'],
//  либо ['taking orders', 'suggesting meals', 'taking payments']
